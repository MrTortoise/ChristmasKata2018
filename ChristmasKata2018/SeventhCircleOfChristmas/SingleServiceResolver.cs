...
namespace ChristmasKata2018.SeventhCircleOfChristmas
{
        ...
        where TService : class
    {
        ...
        private TService GetValueFromResolver()
        {
            ...
            {
                throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture, "Cannot register 2 instances", typeof(TService).Name.ToString(), _callerMethodName));
            }
